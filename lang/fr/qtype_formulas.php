...
$string['localmarknotgraded'] = 'Note: -/{$a->maxmark}';
$string['localmark'] = 'Note: {$a->highestmark}/{$a->maxmark}';
$string['submitfirst'] = 'Envoyer';
$string['submitmore'] = 'Envoyer essai {$a->curtrial} ({$a->curmaxpercent})';
$string['gradinginfo'] = 'soumission #{$a->prevtrial} ({$a->prevmaxpercent}), note brute: {$a->rawmark}';  // show only after second trials
...
$string['pluginnameadding'] = 'Ajouter une question Formules';
$string['pluginnameediting'] = 'Modifier une question Formules';
...
$string['showperanswermark'] = 'Note pour chaque réponse';
...
$string['answermark'] = 'Note par défaut de la partie*';
...
$string['vars2'] = 'Variables d\'évaluation';
...
$string['correctness'] = 'Critères d\'évaluation*';
...
$string['unitpenalty'] = 'Pénalité pour unité fausse (0-1)*';
