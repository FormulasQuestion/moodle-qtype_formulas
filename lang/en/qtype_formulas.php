...
// remove $string['error_answertype_mistmatch'] = 'Answer type mismatch: Numerical answer type requires number and algebraic answer type requires string';
...
// remove $string['error_forbid_char'] = 'Formula or expression contains forbidden characters or operators.';
...
// remove $string['error_validation_eval'] = 'Try evaluation error! ';
// remove $string['error_syntax'] = 'Syntax error.';
...
$string['error_power_00'] = 'power 0^0 is not defined';
...
$string['error_function_argcount'] = 'invalid number of arguments for function \'{$a->function}\': {$a->count} given';
...
$string['error_function_paren'] = 'syntax error: function must be followed by opening parenthesis';
