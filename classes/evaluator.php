...
class evaluator {
    ...
    const PHPFUNCTIONS = [
        ...
        'atan' => [1, 1],
        'atanh' => [1, 1],
        'base_convert' => [3, 3], // FIXME: no test for invocation
        'bindec' => [1, 1],
        'ceil' => [1, 1],
        'cos' => [1, 1],
        'cosh' => [1, 1],
        'decbin' => [1, 1],
        'dechex' => [1, 1], // FIXME: no test
        'decoct' => [1, 1],
        'deg2rad' => [1, 1],
        'exp' => [1, 1],
        'expm1' => [1, 1],
        'fdiv' => [2, 2], // FIXME: no test
        'floor' => [1, 1],
        'hexdec' => [1, 1], // FIXME: no test
        'hypot' => [2, 2], // FIXME: no test
        'intdiv' => [2, 2], // FIXME: no test
        'is_finite' => [1, 1],
        'is_infinite' => [1, 1],
        'is_nan' => [1, 1],
        'log10' => [1, 1],
